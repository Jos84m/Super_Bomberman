                ...
                if self.start_button.collidepoint(e.pos):
                    ...
                    while True:
                        ...
                        select = CharacterSelectWindow(self.screen, self.clock, [
                            {"name": "Bomberman", "gif_path": os.path.join("assets", "GIFS", "player1.gif"), "lives": 3, "speed": 2, "sprite_folder": "WB"},
                            {"name": "Black Bomberman", "gif_path": os.path.join("assets", "GIFS", "player2.gif"), "lives": 5, "speed": 1, "sprite_folder": "BB"},
                            {"name": "Blue Bomberman", "gif_path": os.path.join("assets", "GIFS", "player3.gif"), "lives": 2, "speed": 3, "sprite_folder": "BLB"}
                        ])
