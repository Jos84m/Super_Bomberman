...
class BombermanGame:
    ...
    def load_background_gif(self):
        try:
            gif = Image.open(os.path.join("assets", "GIFS", "Bg1.gif"))
            frames = []
    ...
    def show_game_ending_screen(self):
     ...
     ending_image_path = os.path.join("assets", "SPRITES", "Ending Screen.png")
     ending_img = pygame.image.load(ending_image_path).convert_alpha()
     ending_img = pygame.transform.scale(ending_img, (600, 400))
                ...
                if self.start_button.collidepoint(e.pos):
                    ...
                    while True:
                        ...
                        select = CharacterSelectWindow(self.screen, self.clock, [
                            {"name": "Bomberman", "gif_path": os.path.join("assets", "GIFS", "Player 1.gif"), "lives": 3, "speed": 3, "sprite_folder": "WB", "bombs": 15},
                            {"name": "Black Bomberman", "gif_path": os.path.join("assets", "GIFS", "Player 2.gif"), "lives": 5, "speed": 2, "sprite_folder": "BB", "bombs": 20},
                            {"name": "Blue Bomberman", "gif_path": os.path.join("assets", "GIFS", "Player 3.gif"), "lives": 2, "speed": 4, "sprite_folder": "BLB", "bombs": 10}
                        ])
                        ...
                        while True:
                            ...
                            if mapa_result == "continue":
                                ...
                                if level1_result:
                                    ...
                                    # Nivel 2
                                    while True:
                                        level2 = LevelWindow2(self.screen, self.clock, os.path.join("assets", "GIFS", "Bg3.gif"), selected_character, self, self.volume_settings)
                                    ...
                                    if level2_result:
                                        ...
                                        # Nivel 3
                                        while True:
                                            level3 = LevelWindow3(self.screen, self.clock, os.path.join("assets", "GIFS", "Bg4.gif"), selected_character, self, self.volume_settings)
                                            ...
                                            if level3_result == "reload":
                                                ...
                                                # Inicia el nivel 4
                                                while True:
                                                    level4 = LevelWindow4(self.screen, self.clock, os.path.join("assets", "GIFS", "Bg5.gif"), selected_character, self, self.volume_settings)
