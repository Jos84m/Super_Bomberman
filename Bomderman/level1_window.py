...
class LevelWindow1:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_c:
                        ...
                        level2 = LevelWindow2(self.screen, self.clock, "assets/Bg3.gif", self.selected_character)
                        level2.run()
                        return
    ...
    def run(self):
        while self.running:
            ...
            # Detectar la puerta en el mapa y crear su rectángulo
            door_rect = None
            ...
            # Detectar colisión jugador-puerta
            if door_rect and door_rect.colliderect(self.player.get_rect()):
            ...
            # Detectar colisión de explosiones con jugador
            for explosion in self.explosions:
