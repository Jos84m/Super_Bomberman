...
class LevelWindow2:
    def __init__(self, screen, clock, gif_path, selected_character):
        ...
        self.enemies = [
            Enemy(self.start_x + 13 * self.tile_size, self.start_y + 1 * self.tile_size, "assets/enemy.png", self.tile_size),
            Enemy(self.start_x + 7 * self.tile_size, self.start_y + 5 * self.tile_size, "assets/enemy.png", self.tile_size),
    ...
    def restart_game(self):
        self.__init__(self.screen, self.clock, "assets/Bg3.gif", self.selected_character)
