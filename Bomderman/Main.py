...
class BombermanGame:
    ...
    def load_background_gif(self):
        try:
            gif = Image.open(os.path.join("assets", "Bg3.gif"))
            frames = []
                ...
                if self.start_button.collidepoint(e.pos):
                    ...
                    while True:
                        ...
                        if mapa_result == "continue":
                            ...
                            pygame.mixer.music.play(-1)
                            level1 = LevelWindow1(self.screen, self.clock, "assets/Bg2.gif", selected_character)
                            level1.run()

                            # Nivel 2
                            pygame.mixer.music.stop()
                            pygame.mixer.music.load(os.path.join("assets", "Level 2.mp3"))
                            pygame.mixer.music.play(-1)
                            level2 = LevelWindow2(self.screen, self.clock, "assets/Bg3.gif", selected_character)
                            level2.run()

                            # Nivel 3
                            pygame.mixer.music.stop()
                            pygame.mixer.music.load(os.path.join("assets", "Level 3.mp3"))
                            pygame.mixer.music.play(-1)
                            level3 = LevelWindow3(self.screen, self.clock, "assets/Bg5.gif", selected_character)
                            level3.run()

                            # Victoria final
                            pygame.mixer.music.stop()
                            pygame.mixer.music.load(os.path.join("assets", "Victory.mp3"))
                            pygame.mixer.music.play(-1)
                            self.show_final_victory_screen()

                            # Volver a música principal
                            pygame.mixer.music.stop()
                            pygame.mixer.music.load(os.path.join("assets", "Title screen.mp3"))
                            pygame.mixer.music.play(-1)
                            return
