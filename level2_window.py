...
class LevelWindow2:
    def __init__(self, screen, clock, gif_path, selected_character, main_game, volume_settings):
        ...
        # Mapa con trampas indicadas con 'S'
        self.level_map = [
            list("###############"),
            list("#P      ?     #"),
            list("# # #S# #S# # #"),
        ...
        self.enemies = [
            ...
            Enemy(self.start_x + 6 * self.tile_size, self.start_y + 5 * self.tile_size, enemy_sprite_folder, self.tile_size)
        ]
        ...
        self.hud = HUD(self.screen, pygame.time.get_ticks(), lives=self.lives, score=self.score, level=2)
