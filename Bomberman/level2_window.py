...
class LevelWindow2:
    def __init__(self, screen, clock, gif_path, selected_character):
        ...
        # Laberinto original del nivel 2
        self.level_map = [
            list("###############"),
            list("#P   #   #   E#"),
            list("# # # # # # # #"),
        ...
        player_gif = selected_character.get("gif_path", os.path.join("assets", "GIFS", "player1.gif"))
        self.player = Player(self.start_x + 1 * self.tile_size, self.start_y + 1 * self.tile_size, player_gif)

        self.enemies = [
            Enemy(self.start_x + 1 * self.tile_size, self.start_y + 11 * self.tile_size, "assets/enemy.png", self.tile_size),
            Enemy(self.start_x + 13 * self.tile_size, self.start_y + 11 * self.tile_size, "assets/enemy.png", self.tile_size)
        ]
        ...
        # Control de música y movimiento
    ...
    def show_game_over_screen(self):
        # Detener música del nivel y reproducir Game Over OST una vez
        pygame.mixer.music.stop()
        pygame.mixer.music.load(os.path.join("assets", "OST", "Game Over.mp3"))
        pygame.mixer.music.play()  # Solo una vez
